...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Kemin_Yolk_Sensor.ErrorDialog+PositiveListener, Kemin Yolk Sensor, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ErrorDialog_PositiveListener.class, __md_methods);
	}
	...
	public ErrorDialog_PositiveListener ()
	{
		...
		if (getClass () == ErrorDialog_PositiveListener.class)
			mono.android.TypeManager.Activate ("Kemin_Yolk_Sensor.ErrorDialog+PositiveListener, Kemin Yolk Sensor, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
