...
public class CameraTextureListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Kemin_Yolk_Sensor.Listeners.CameraTextureListener, Kemin Yolk Sensor, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", CameraTextureListener.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == CameraTextureListener.class)
			mono.android.TypeManager.Activate ("Kemin_Yolk_Sensor.Listeners.CameraTextureListener, Kemin Yolk Sensor, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public CameraTextureListener (md5fd90a3429e96b59e6ba4bef589d472ff.CameraFunction p0)
	{
		super ();
		if (getClass () == CameraTextureListener.class)
			mono.android.TypeManager.Activate ("Kemin_Yolk_Sensor.Listeners.CameraTextureListener, Kemin Yolk Sensor, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Kemin_Yolk_Sensor.CameraFunction, Kemin Yolk Sensor, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
