...
{
    public class PermissionsDialog : DialogFragment
    {
        ...
        private class PositiveListener : Java.Lang.Object, IDialogInterfaceOnClickListener
        {
            ...
            {
                FragmentCompat.RequestPermissions(parentFragment,
                                new string[] { Manifest.Permission.Camera }, CameraFunction.REQUEST_CAMERA_PERMISSION);
            }
        }
        ...
        private class NegativeListener : Java.Lang.Object, IDialogInterfaceOnClickListener
        {
            public void OnClick(IDialogInterface dialog, int which)
            {
                Activity activity = parentFragment.Activity;
                if (activity != null)
                {
                    activity.Finish();
                }
        ...
        public override Dialog OnCreateDialog(Bundle savedInstanceState)
        {
            ...
            return new AlertDialog.Builder(Activity)
                .SetMessage(Resource.String.get_permission)
